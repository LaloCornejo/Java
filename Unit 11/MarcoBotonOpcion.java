...
public class MarcoBotonOpcion extends JFrame {
    ...
    public MarcoBotonOpcion(){
        ...
        tipoLetraSimple = new Font( "Arial", Font.PLAIN, 14 );
        tipoLetraNegrita = new Font( "Arial", Font.BOLD, 14 );
        tipoLetraCursiva = new Font( "Arial", Font.ITALIC, 14 );
        tipoLetraNegritaCursiva = new Font( "Arial", Font.BOLD + Font.ITALIC, 14 );
