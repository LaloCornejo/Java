...
public class LibroDCalificaciones {
    private String nombreDelCurso;
    
    private int calificaciones[];

    public LibroDCalificaciones( String nombre, int arregloCalif[] ){
    ...
    public void procesarCalificaciones(){
        ...
        System.out.printf( "La calificacion mas alta es: %d\nLa calificacion mas baja es: %d\n\n",
        obtenerMaxima(), obtenerMinima() );
