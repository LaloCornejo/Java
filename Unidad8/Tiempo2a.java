public class Tiempo2a {
    ...
    public Tiempo2a( int h ){

        this( h, 0 ,0 );
    }
    public Tiempo2a( int h, int m ){

        this( h, m ,0 );
    }
    public Tiempo2a( int h, int m, int s ){

        establecerTiempo( h, m, s );
    }
    public Tiempo2a( Tiempo2a tiempo ){
    ...
    public String toString(){
        return String.format( "%d:%02d:%02d %s", (( obtenerHora() == 12 ) ? 12 : obtenerHora() % 12 ), obtenerMinuto(), obtenerSegundo(), ( obtenerHora() < 12 ? "AM" : "PM" ) );
    }
}